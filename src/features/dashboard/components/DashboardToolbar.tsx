...
export function DashboardToolbar() {
  return (
    <div className="bg-white rounded-lg border border-slate-200 p-4 shadow-sm flex justify-center items-center gap-4">
      ...
      <button className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 border border-blue-700 rounded-md shadow-sm text-xs font-semibold text-white hover:bg-blue-700 ml-2">
